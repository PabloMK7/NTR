...
void remotePlaySendFrames() {
	...
	while (1) {
		...
		u32 thisProcVA = (current_fb ? 0x08000000 : 0x0A000000) | (currentUpdating ? 0x01000000 : 0);

		if (currentUpdating) {
			// send top
			rpCopyFramebuffers(1);
			currentTopId += 1;
